...
categ = ['CASCO','ADITAMENTO','PANGA','VELA I CARENA','VELA I MODULO','SAMA I CARENA','SAMA I MODULO']
df_ratio = df_ratio[df_ratio['Categoría'].isin(categ)]

selector_categoria = st.sidebar.selectbox("Seleccione categoria:", categ)
